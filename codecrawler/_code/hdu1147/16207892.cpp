...
int find(node a,node b) //å¤æ­æ¯å¦ç¸äº¤
{
    double c[4];
...
/*
    åéç§¯ï¼
    aÃb>0æ¶ï¼bå¨açéæ¶éæ¹åï¼aÃb=0æ¶ï¼å±çº¿ï¼aÃb<0æ¶ï¼bå¨açé¡ºæ¶éæ¹åã
    å¯¹äºä¸¤æ¡çº¿æ®µAB,CDï¼
    åªæCï¼Då¨ABæå¨ç´çº¿çä¸¤ç«¯ä¸A,Bå¨CDæå¨ç´çº¿çä¸¤ç«¯å°±è½ä¿è¯æäº¤ç¹ã
    å¯ä»¥å¾å°(ABÃAC)*(ABÃAD)<=0&&(CAÃCD)*(CBÃCD)<=0æ¶ç¬¦åæ¡ä»¶ã
