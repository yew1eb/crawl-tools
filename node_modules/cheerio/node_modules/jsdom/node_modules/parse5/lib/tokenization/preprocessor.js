...
Preprocessor.prototype.advanceAndPeekCodePoint = function () {
    ...
    //OPTIMIZATION: first perform check if the _code point in the allowed range that covers most common
    //HTML input (e.g. ASCII codes) to avoid performance-cost operations for high-range _code points.
...
Preprocessor.prototype._processHighRangeCodePoint = function (cp) {
    ...
    if (this.pos !== this.lastCharPos) {
        ...
        if (isSurrogatePair(cp, nextCp)) {
            //NOTE: we have a surrogate pair. Peek pair character and recalculate _code point.
            this.pos++;
